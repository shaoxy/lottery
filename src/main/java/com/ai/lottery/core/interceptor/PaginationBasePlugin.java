...
import com.ai.lottery.core.dao.PageCondition;
...
import com.ai.lottery.core.dao.PageHolder;
...
//            }
    ...
    private MappedStatement buildMappedStatement(MappedStatement ms, BoundSql boundSql, String sql) {
        Builder builder = new MappedStatement.Builder(ms.getConfiguration(), ms.getId(), new BoundSqlSqlSource(ms, boundSql, sql),
